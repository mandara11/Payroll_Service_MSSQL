...
-- Ability to extend employee_payroll data to store employee information like employee phone.
...
-- Ability to extend employee_payroll data to store employee information like address.
-- Add Default Value for address field.
alter table employee_payroll add address varchar(250) NOT NULL default'Jaunpur';  --Adding address field with default value
select *  from employee_payroll

-- Ability to extend employee_payroll data to store employee information like department.
-- Ensure employee department is non nullable fields.
...
--Create Table Department   relation M-M
...
--Create Table DeptEmployee   relation M-M
...
--Create Table Addresses  Relation 1-1
